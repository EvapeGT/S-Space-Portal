...
foreach ($_SESSION['paymentsData'] as $payment) {
  // Check if 'PaymentDate' exists in the payment array
...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.html" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-lg-block">S-Space Dormitel</span>
      </a>
          ...
          <div class="row">
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Total Tenants <span>| Today</span></h5>
              ...
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
  <h6><?php echo "₱" . number_format($_SESSION['totalRevenueThisMonth'], 2); ?></h6>
  ...
  <div class="d-flex align-items-center">
    ...
    <div class="ps-3">
    <h6><?php echo count($_SESSION['tenantsData']) . "/100"; ?></h6>
  ...
  const paymentAmounts = <?php echo $paymentAmountsJson; ?>;
  ...
  new ApexCharts(document.querySelector("#reportsChart"), {
    ...
    colors: ['#4154f1', '#2eca6a', '#ff771d', '#f34e4e'],
    fill: {
      type: "gradient",
      gradient: {
        shadeIntensity: 1,
      ...
      x: {
        ...
        <div class="col-lg-4">
          ...
          <div class="card">
            ...
            <div class="card-body pb-0">
              <h5 class="card-title">Payment Status <span>| Today</span></h5>
